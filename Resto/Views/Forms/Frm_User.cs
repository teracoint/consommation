...
{
    public partial class Frm_User : DevExpress.XtraEditors.XtraForm, IProduit
    {
        ...
        public int QuantStock { get => Convert.ToInt32(txtQuant.Text); set => txtQuant.Text = value.ToString(); }
        public int PrixAchat { get => Convert.ToInt32(txtPrixAchat.Text); set => txtPrixAchat.Text = value.ToString(); }
